...
!!! example "安装示例"
    ...
    === "手动安装【小狼毫】"
        ...
        ![GitHub Release](https://img.shields.io/github/v/release/rime/weasel?style=flat-square)
    ...
    === "第三方包管理工具安装【小狼毫】"
        ...
        - 或者使用 [UniGetUI](https://github.com/devolutions/unigetui)
            （为winget/choco/scoop等命令行包工具提供GUI界面）
...
!!! example "安装示例"
    ...
    === "手动安装【鼠须管】"
        ...
        ![GitHub Release](https://img.shields.io/github/v/release/rime/squirrel?style=flat-square)
...
!!! note
    ...
    === "Fcitx5框架【推荐】"
        ...
        **Fcitx5**（小企鹅输入法） 是Fcitx （Free Chinese Input Tool of X，旧全名） 的“重写版本”，
        面向更现代的桌面框架，性能更好，但是配置相对复杂。
...
3. 卸载输入法
     - 使用包管理器（如 *homebrew/winget/apt* 等），可以通过包管理器卸载。
     - 手动卸载：
        - Windows【小狼毫】提供自带的卸载程序，可以使用卸载程序进行卸载；
        - macOS【鼠须管】打开`/Library/Input Methods`目录，右键`Squirrel.app`选择【移到废纸篓】（Move to Trash）即可。
        - Fcitx5-macOS，输入法图标右键点击【关于 Fcitx5 macOS】，弹窗页面选择【卸载】。
