...
基於 IBus 輸入法框架。
請 [查看](../../wiki/RimeWithIBus.md) 各 Linux 發行版安裝說明，或從源碼編譯安裝。
...
您可通過方案選單切換已經安裝的輸入方案。〔[說明書](../../wiki/UserGuide.md)〕
...
這篇《[定製指南](../../wiki/CustomizationGuide.md)》，相信能解答您的不少疑問。

熟悉了基本的定製方法以後，如果需要製作自己的輸入方案，請進階閱讀《[Rime 輸入方案設計書](../../wiki/RimeWithSchemata.md)》。
