...
由[Polyhedron古韻](http://i.youku.com/u/UMTcwNzA5NjM2)創造的[中古漢語拼音](http://zh.wikipedia.org/wiki/User:Polyhedron/中古漢語拼音)，適用於[《廣韻》](http://ytenx.org/kyonh/)音系。

[雪齋](https://github.com/LEOYoon-Tsaw)在此基礎上製作了[廣韻查詢](https://gist.github.com/lotem/7129e5e6da70b53a5828)[^1]輸入方案，可以使用多種編碼輸入漢字，查閱其對應的中古音。

[^1]: 更新鏈接*
  [lotem/middle_chinese_lookup.schema.yaml](https://gist.github.com/lotem/e964a81c1ea457a6ae92),
  [LEOYoon-Tsaw/Middle_Chinese_Lookup.yaml](https://gist.github.com/LEOYoon-Tsaw/7513396),
...
輸入方案爲[粵拼](http://zh.wikipedia.org/wiki/香港語言學學會粵語拼音方案)。
...
輸入方案爲[佛振](https://github.com/lotem)製作的[中州注音法](https://github.com/lotem/rime-zhung)，中原官話注音結合[宮保拼音](../../wiki/ComboPinyin.md)的並擊輸入方式。
...
[宮保拼音](../../wiki/ComboPinyin.md) 是一種用電腦鍵盤多鍵並擊輸入拼音的方法。
