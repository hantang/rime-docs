...
* [鼠鬚管介面定製指南](./Customization.md)
* [鼠鬚管：如何查找合用字體之名](./FindFontname.md)
...
* 其它小 Tips
  * [使用快捷鍵同步用戶資料](./Shortcut.md)
  * [在Squirrel使用上思源字體](./UseFontSourceHan.md)
  * [实现Shift_L-按下时切换输入法即Shift_L-代替Ctrl_Space](./SwitchInputMethod.md)
  * [禁用 Squirrel 英文模式，使用左侧 Shift 切换中英](./SwitchLanguage.md)
...
* [Squirrel UI Customization Guide](./Customization.md)
* [Squirrel: How to find correct font names](./FindFontname.md)
...
* Tips
  * [Use a Shortcut to Sync User Sir](./Shortcut.md)
