...
* Update squirrel introduction in README.md by @determ1ne in https://github.com/rime/squirrel/pull/777
...
![有詩爲證](../wiki/images/squirrel-vertical-text-light.png)
![有圖爲證](../wiki/images/squirrel-vertical-text-dark.png)
...
* 優化：【粵拼】兼容[教育學院拼音方案](https://zh.wikipedia.org/wiki/教育學院拼音方案)
